...
const ads = (teks) => {
sock.sendMessage(from, { text : teks, contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }}}, { quoted : m})
}
const detect = (teks) => { 
...
// console log command ketika dalam group
    ...
    let daftar3 = [{buttonId: `.verify`, buttonText: {displayText: '🏷️MENU'}, type: 1},]

      
const sendButMessage = (id, image1, text1, desc1, but = [], options = {}) => {
      let buttonMessage = {
      image: image1,
      caption: text1,
      footer: desc1,
  ...
  axios.request(options).then(function (res) {
    console.log(res.data);
         for (let i = 0; i < res.data.length; i++) { 
          const list = {title: `Ig Story ${q}`,
          rows: [
              {
               title: `Pencarian ${q} `, 
               rowId: `#get${res.data[i].type === "Video" ? "mp4" : "jpeg"} ${res.data[i].media}`,
               description: `💻 Type : ${res.data[i].type === "Video" ? "video 🎥" : "foto 📸"} ${i + 1}`
              }, 
              ]
             }
             sections.push(list)   
...
case prefix+'emojimix2': {
  ...
  let encmedia = await sock.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.packname2, categories: res.tags, contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }} })
  await fs.unlinkSync(encmedia)
  }
  }
  addCmd(command.slice(1), 1, commund)
  ...
  case prefix+'emoji': {
      ...
      let mese = await sock.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption:"Done!", contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }}}, {quoted:m})
      ...
      sock.sendMessage(m.chat, {sticker: buff, packname: global.packname, author: global.packname2, contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }}}, {quoted: m})
    }
      addCmd(command.slice(1), 1, commund)
      break
      case prefix+'ttp': {
    ...
    encmedia = await sock.sendImageAsSticker(from, buff, m, { packname: global.packname, author: global.packname2, contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }}})
    await fs.unlinkSync(encmedia)
  }
    addCmd(command.slice(1), 1, commund)
    break
      ...
      encmedia = await sock.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.packname2, contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }}})
      await fs.unlinkSync(encmedia)
      }
      addCmd(command.slice(1), 1, commund)
      break
...
case prefix+'swm': case prefix+'stickerwm': {
  ...
  sock.sendMessage(m.chat, { image: buffer, contextInfo: {
    "externalAdReply": { 
    "title" : global.namebot,
    "mediaType" : 1,
    "renderLargerThumbnail" : false , 
  ...
  await sock.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, contextInfo: {
    "externalAdReply": { 
    "title" : global.namebot,
    "mediaType" : 1,
    "renderLargerThumbnail" : false , 
  ...
  sock.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg', contextInfo: {
    "externalAdReply": { 
    "title" : global.namebot,
    "mediaType" : 1,
    "renderLargerThumbnail" : false , 
  ...
  let { toAudio } = require('./lib/converter')
  let audio = await toAudio(media, 'mp4')
  sock.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${sock.user.name} (${m.id}).mp3`, contextInfo: {
    "externalAdReply": { 
    "title" : global.namebot,
    "mediaType" : 1,
    "renderLargerThumbnail" : false , 
  ...
  sock.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true, contextInfo: {
    "externalAdReply": { 
    "title" : global.namebot,
    "mediaType" : 1,
    "renderLargerThumbnail" : false , 
  ...
  let media = await sock.downloadAndSaveMediaMessage(quoted)
  let webpToMp4 = await webp2mp4File(media)
  await sock.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true, contextInfo: {
    "externalAdReply": { 
    "title" : global.namebot,
    "mediaType" : 1,
    "renderLargerThumbnail" : false , 
...
//=========< Search Menu >==========
          ...
          footer: global.footer,
          buttons: buttons,
          headerType: 4,contextInfo: { "externalAdReply": { "title" : global.namebot, "mediaType" : 1, "renderLargerThumbnail" : false, "showAdAttribution": true, "mediaUrl": global.linkgrupss, "thumbnail": di, "sourceUrl" : global.linkgrupss }}
          }
          sock.sendMessage(m.chat, buttonMessage, { quoted: m })
          }).catch(_ => _)
          } catch {
